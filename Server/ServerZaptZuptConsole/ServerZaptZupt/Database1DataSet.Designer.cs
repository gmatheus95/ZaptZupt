...
namespace ServerZaptZupt.Database1DataSetTableAdapters {
...
SELECT sender, receiver, msgTimeStamp, msg FROM messages WHERE (msgTimeStamp = @msgTimeStamp) AND (receiver = @receiver) AND (sender = @sender)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ServerZaptZupt.Properties.Settings.Default.Database1ConnectionString;
        }
